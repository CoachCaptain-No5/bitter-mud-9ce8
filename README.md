...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/bitter-mud-9ce8#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/bitter-mud-9ce8
```

A live public deployment of this template is available at [https://bitter-mud-9ce8.templates.workers.dev](https://bitter-mud-9ce8.templates.workers.dev)
